        ...
        <div className="flex flex-col lg:flex-row lg:mt-16">
          ...
          className="flex-1 lg:bg-services lg:bg-bottom bg-no-repeat mix-blend-lighten mb-12 lg:mb-0">
            ...
            <h3 className="h3 mb-12 max-w-[455px]">
              I'm a Developer ,learner ,Computer science graduate .
            </h3>
            <button className="btn btn-sm"><a href="https://github.com/shettysushmita05"> See my work </a></button>
          </motion.div>
          {/* services */}
          <motion.div
                  ...
                  return (
                    <div className="border-b border-white/20 h-[142px] mb-[36px] flex" key={index}>
                      ...
                      <div className="flex  flex-col flex-1 items-end">
                        ...
                        <a href="https://github.com/shettysushmita05"className="text-gradient text-sm">{link}</a>
                      </div>
                    </div>
